...
echo "  3. (Optional) Wire the feedback LED and soft power button (see README)."
...
echo "  6. For maximum power resilience, consider enabling the read-only overlay"
echo "     filesystem:  sudo raspi-config  ->  Performance  ->  Overlay File System."
echo "  7. Start the hub:  sudo systemctl start pixelpostman"
